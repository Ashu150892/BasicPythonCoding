...
append()   --> Add  -- adds the entire list as one item.
...
min()
max()
sort()   --> arranges the list in ascending order — smallest to largest.
count()  --> tell total occurance of element in list.
